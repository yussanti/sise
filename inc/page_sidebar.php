...
<div id="sidebar">
    ...
    <div id="sidebar-brand" class="themed-background">
        <a href="" class="sidebar-title">
            <span class="sidebar-nav-mini-hide">Simple O<strong></strong></span>
        </a>
    </div>
    <!-- END Sidebar Brand -->
    ...
    <div id="sidebar-extra-info" class="sidebar-content sidebar-nav-mini-hide">
        ...
        <div class="text-center">
            <small>Crafted with <i class="fa fa-heart text-danger"></i> by <a href="http://goo.gl/vNS3I" target="_blank">yussanti</a></small><br>
