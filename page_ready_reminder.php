...
<div id="login-container">
    ...
    <div class="block animation-fadeInQuickInv">
        ...
        <div class="block-title">
            <div class="block-options pull-right">
                <a href="index.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="Back to login"><i class="fa fa-user"></i></a>
            </div>
            <h2>Reminder</h2>
        </div>
        <!-- END Reminder Title -->
    ...
    <footer class="text-muted text-center animation-pullUp">
        <small><span id="year-copy"></span> &copy; <?php echo $template['name'] . ' ' . $template['version']; ?></small>
    </footer>
    <!-- END Footer -->
</div>
<!-- END Login Container -->
